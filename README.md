...
+ [`nz-dhb-branching-beta.0.6.nlogo`](models/nz-dhb-branching-beta.0.6.nlogo?raw=true) Click [this link](http://southosullivan.com/misc/nz-dhb-branching-beta.0.6.html) for the web version.
