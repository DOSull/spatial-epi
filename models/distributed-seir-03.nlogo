...
to setup
  ...
  read-locales-from-file "geo/dhbs-nl.csv"

  ask locales [
    let total-w sum [1 / distance myself] of other locales
    ask other locales [
      let w (1 / distance myself) / total-w
      create-connection-from myself [
        set color red
        set thickness w
      ]
    ]
...
to draw
  ...
  set size sqrt (2 * pop-0 / max [pop-0] of locales)
end


to read-locales-from-file [fname]
  file-open fname
  show file-read-line
  ...
  while [not file-at-end?] [
    ...
    create-locales 1 [
      setxy 2 + world-width * x / 5 2 + world-height * y / 5
      set label name
      set pop-0 floor (p / 10)
...
to-report get-effective-infected
  report infected + flow-rate * sum [thickness * [infected] of other-end] of my-in-connections
end

to-report get-effective-presymptomatic
  report presymptomatic + flow-rate * sum [thickness * [presymptomatic] of other-end] of my-in-connections
end
...
716
data
\"Auckland\" 0.341165093838245 1.26684345637532 538840\n\"Bay of Plenty\" 1.13859988431888 0.658399572541048 236820\n\"Canterbury\" -0.984389106990874 -1.19374311810225 562870\n\"Capital and Coast\" 0.165894059153851 -0.438902822866233 316620\n\"Counties Manukau\" 0.230439043314919 1.01606589733076 557790\n\"Hawke's Bay\" 1.04213422465207 0.170967078076671 165360\n\"Hutt\" 0.230852184167153 -0.467031138675391 149270\n\"Lakes\" 0.760222017881952 0.463861388494924 110040\n\"Midcentral\" 0.579431413952139 -0.181699081028052 178240\n\"Nelson Marlborough\" -0.619782966403092 -0.611448249461144 150280\n\"Northland\" -0.279440075411107 1.65442004215251 178500\n\"South Canterbury\" -1.65052378289472 -1.58610151776667 60025\n\"Southern\" -2.38854190499352 -2.09205857363818 328230\n\"Tairawhiti\" 1.5847147284189 0.578215603756158 48965\n\"Taranaki\" -0.0068313609077733 0.226911968758374 119640\n\"Waikato\" 0.415045659445041 0.694450266295767 417130\n\"Wairarapa\" 0.487910926311789 -0.44761885603152 44845\n\"Waitemata\" 0.0554735341139867 1.25453774506367 622350\n\"West Coast\" -1.56621872738316 -1.07619650199163 32445\n\"Whanganui\" 0.46384515541532 0.110126840715839 64565
1
1
String
