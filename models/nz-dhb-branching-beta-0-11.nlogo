...
locales-own [
  ...
  recent-tests       ;; list of recent numbers of tests in this local per time-horizon
...
to update-statistics
  ...
  ask locales [
    ...
    let new-tests new-cases + ;; new-cases we assume all got tested (which may be optimistic)
        (random-binomial (new-infected - new-cases) test-rate-presymp) + ;; new subclinical cases assume a lower rate
