...
to-report output-locale
  report join-list (list ticks who name pop-0 susceptible exposed presymptomatic infected recovered dead tests tests-positive new-exposed new-presymptomatic new-infected new-recovered new-dead alert-level) ","
end

to-report output-locale-header
  report "ticks,who,name,pop-0,susceptible,exposed,presymptomatic,infected,recovered,dead,tests,tests-positive,new-exposed,new-presymptomatic,new-infected,new-recovered,new-dead,alert-level"
end
